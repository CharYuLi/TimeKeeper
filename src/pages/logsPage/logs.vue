<template>
  <view class="container">
    ...
    <view class="nav-tabs">
      ...
      <view class="nav-tab" :class="{ active: activeTab === 'feedback' }" @click="switchTab('feedback')">家长反馈</view>
    </view>
    ...
    <view class="content">
      <view v-show="activeTab === 'performance'" class="tab-content">
        ...
        <view class="performance-card">
          ...
          <p>今天小明表现很棒！数学作业完成质量高，英语朗读声音洪亮。建议加强口算练习，继续加油！</p>
        </view>
      </view>
      ...
      <view v-show="activeTab === 'feedback'" class="tab-content">
        <view class="performance-card">
          ...
          <view style="background: #f8f9ff; padding: 15px; border-radius: 10px; margin-bottom: 15px;">
            <strong>家长留言：</strong>
            <p style="margin-top: 5px;">希望老师能多关注孩子的口算能力，谢谢！</p>
          </view>
